...
web_install(){
	...
	mkdir /www
	wget https://github.com/liyanglan/V2Ray_h2-tls_Website/raw/master/V2rayWebsite.tar.gz
...
win64_v2ray(){
	...
	wget https://github.com/liyanglan/V2Ray_h2-tls_Website/raw/master/V2rayPro.zip
